      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/business" element={<SaaSPage />} />

            <Route path="/portal/staff" element={<PrivateRoute scope="staff"><StaffPortalPage /></PrivateRoute>} />
            <Route path="/portal/kds" element={<PrivateRoute scope="staff"><KDSPage /></PrivateRoute>} />
            <Route path="/portal/pos" element={<PrivateRoute scope="admin"><POSPortalPage /></PrivateRoute>} />
            <Route path="/portal/admin/*" element={<PrivateRoute scope="admin"><AdminPortalPage /></PrivateRoute>} />
            <Route path="/portal/analytics" element={<PrivateRoute scope="admin"><AnalyticsPage /></PrivateRoute>} />
            ...
            <Route path="/saas" element={<Navigate to="/business" replace />} />
