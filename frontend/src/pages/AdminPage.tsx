...
export default function AdminPage({ navigate }: { navigate: Navigate }) {
  return (
    <div style={{ minHeight:'100vh', background:'#0D0D0D', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <h2 style={{ fontFamily:"'Playfair Display',serif", color:GOLD, fontSize:28, marginBottom:8 }}>Administration</h2>
      <p style={{ color:'#555', fontSize:14, marginBottom:32 }}>Tableau de bord — Accès Manager</p>
